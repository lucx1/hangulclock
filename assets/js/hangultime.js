...
function cktd() {
	...
	document.getElementById("koreandt").innerHTML = "<p>오늘은 " + koreantime[4] + koreantime[5] + koreantime[6] + koreantime[7] + "입니다.</p><p>지금 시간은 " + koreantime[0] + koreantime[1] + koreantime[2] + koreantime[3] + "입니다.</p>";
}
